...
public abstract class PhysicalEntity extends Entity {
	...
	/*
	 * Moved this into Obstacle - PhysicalEntity should not need to rely on
	 * knowledge of subclasses
	 * 
	 * if (this instanceof Obstacle) { phi -= speed * timePerFrame / radius;
	 * } else { phi += speed * timePerFrame / radius; }
	 */
