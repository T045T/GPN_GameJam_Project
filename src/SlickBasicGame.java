...
public class SlickBasicGame extends BasicGame{
    ...
    public void init(GameContainer gc)
		...
		player = new Player("foo", 5, 60, (float)Math.PI, 0.01f);
			...
			throws SlickException
    {
        ...
        plane.draw(player.getCenterX()+this.x/2, player.getCenterY()+this.y/2, scale);
...
>>>>>>> d55ca6fe94f964f029f579793d56fc173e1b7c8e
>>>>>>> ad82e58bed1dae5f621575a1959da8d7f67635df
}